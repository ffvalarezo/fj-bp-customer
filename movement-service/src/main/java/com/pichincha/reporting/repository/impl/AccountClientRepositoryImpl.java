package com.pichincha.reporting.repository.impl;
...
public class AccountClientRepositoryImpl implements AccountClientRepository {
    ...
    public AccountClientRepositoryImpl(
    ...
    @Override
    public Mono<List<AccountRequest>> getAccountsByCustomerId(String customerId, WebClientHeaderHelper headers) {
        ...
        WebClient webClient = webClientBuilder.clientConnector(new ReactorClientHttpConnector(httpClient))
                ...
                .defaultHeaders(headers::applyTo)
