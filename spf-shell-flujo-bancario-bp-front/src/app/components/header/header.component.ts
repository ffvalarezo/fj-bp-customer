...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  // Navegación usando eventos genéricos (ya no se usa)
  // Se removió onNavigationClick porque ahora usamos navigateToItem directamente
  ...
  // Getter para el usuario actual (prioriza JWT sobre input)
  ...
  onItemSelected = output<{item: any, label: string, route: string, timestamp: string}>();
