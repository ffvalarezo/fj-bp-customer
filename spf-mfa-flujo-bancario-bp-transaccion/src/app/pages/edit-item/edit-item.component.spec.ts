...
describe('EditItemComponent', () => {
  ...
  it('should get description control', () => {
    expect(component.description).toBe(component.registerForm.get('description'));
  });
  ...
  it('should get discountPercentage control', () => {
    expect(component.discountPercentage).toBe(component.registerForm.get('discountPercentage'));
  });
