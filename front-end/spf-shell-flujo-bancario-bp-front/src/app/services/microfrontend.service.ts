...
export class MicrofrontendService {
  ...
  private microfrontends: MicrofrontendInfo[] = [
    ...
    },
    {
      ...
      port: 4201,
      remoteEntryUrl:
        "http://localhost:4201/spf-mfa-flujo-bancario-bp-cliente/remoteEntry.js",
    },
    {
      title: "Cuenta",
      ...
      port: 4202,
      remoteEntryUrl:
        "http://localhost:4202/spf-mfa-flujo-bancario-bp-movimiento/remoteEntry.js",
    },
    {
      title: "Transacción",
      ...
      isActive: false,
      port: 4203,
      remoteEntryUrl: "http://localhost:4203/spf-mfa-flujo-bancario-bp-transaccion/remoteEntry.js",
    },
  ];
  ...
  private checkSingleMicrofrontend(
    mf: MicrofrontendInfo
  ): Observable<MicrofrontendInfo> {
    if (mf.route === "home") {
      return of({ ...mf, isActive: true });
    }
    return this.http
      .get(mf.remoteEntryUrl, {
        responseType: "text",
